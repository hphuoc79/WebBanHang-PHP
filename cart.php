            ...
            <div class="cart-content row">
                ...
                <div class="cart-content-right">
                    ...
                    <div class="cart-content-right-text">
                        <p>Bạn sẽ được miễn phí ship khi đơn hàng của bạn có tổng giá trị trên 1,000,000<sup>đ</sup></p><br>
                        <?php
                        if($TT>= 1000000) {
                        ?>
                        ...
                        ?>
                         ...
                         <p style="color: red;font-weight: bold;">Mua thêm <span style="font-size: 18px;"><?php $them = 1000000 - $TT; $resultC = number_format($them); echo $resultC  ?><sup>đ</sup></span> để được miễn phí SHIP</p>
                        <?php
                        }
                        ?>
                    </div>
