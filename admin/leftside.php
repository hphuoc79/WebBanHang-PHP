...
<section class="admin-content row space-between">
        ...
        <div class="header-top-left">
            <a href="index.php"><p> <span>Cala</span> Admin</p></a>
        </div>
            <ul>
                <li><a  href="#"> <img style="width:20px" src="icon/hi.png" alt="">Chào:  <span style="color:blueviolet; font-size:22px"><?php echo Session::get('admin_name') ?></span></a>
